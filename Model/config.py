...
parser.add_argument("--lr_unet", type=float, help="UNet learning rate",
                    dest="lr_unet", default=4e-4)
parser.add_argument("--lr_ext", type=float, help="Extractor learning rate",
                    dest='lr_ext', default=0.03)
